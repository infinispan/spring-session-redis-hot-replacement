...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class IoSpringLibraryAccessors extends SubDependencyFactory {
        ...
        private final IoSpringSecurityLibraryAccessors laccForIoSpringSecurityLibraryAccessors = new IoSpringSecurityLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at io.spring.security
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public IoSpringSecurityLibraryAccessors getSecurity() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForIoSpringSecurityLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class IoSpringSecurityLibraryAccessors extends SubDependencyFactory {
        private final IoSpringSecurityReleaseLibraryAccessors laccForIoSpringSecurityReleaseLibraryAccessors = new IoSpringSecurityReleaseLibraryAccessors(owner);

        public IoSpringSecurityLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at io.spring.security.release
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public IoSpringSecurityReleaseLibraryAccessors getRelease() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForIoSpringSecurityReleaseLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class IoSpringSecurityReleaseLibraryAccessors extends SubDependencyFactory {

        public IoSpringSecurityReleaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for plugin (io.spring.gradle:spring-security-release-plugin)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("io.spring.security.release.plugin");
        }
    ...
    public static class OrgLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at org.awaitility
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class OrgAwaitilityLibraryAccessors extends SubDependencyFactory {
        ...
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("org.awaitility.awaitility");
        }
    ...
    public static class OrgVersionAccessors extends VersionFactory  {
        ...
        public OrgVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.slf4j (2.0.12)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class OrgSpringframeworkVersionAccessors extends VersionFactory  {
        ...
        public OrgSpringframeworkVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.springframework.boot (3.2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
